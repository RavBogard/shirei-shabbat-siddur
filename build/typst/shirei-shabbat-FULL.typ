...
// ============================================================================
#import "book.typ": *
#import "editions/shabbat-maariv.typ": EDITION
#show: book.with(edition: EDITION)

// ---------- FRONT MATTER (unnumbered) ----------
#include "content/shabbat/frontmatter.typ"
...
#sectionopener(0, "Welcoming Shabbat", "קַבָּלַת שַׁבָּת",
  ...
  compact: true)
#include "content/shabbat/kabbalat-inline.typ"
#include "content/shabbat/psalms-A.typ"
#include "content/shabbat/psalms-B.typ"
#include "content/shabbat/ana-bkoach.typ"
#include "content/shabbat/lcha-dodi.typ"
#include "content/shabbat/psalms-92-93.typ"
...
#sectionopener(1, "Sh'ma & Its Blessings", "שְׁמַע וּבִרְכוֹתֶיהָ",
  ...
  compact: true)
#include "content/shabbat/maariv-before.typ"
#include "content/shared/maariv-shma.typ"
#include "content/shabbat/maariv-after.typ"
...
#sectionopener(2, "Amidah", "עֲמִידָה",
  ...
  compact: true)
#include "content/shabbat/amidah-silent.typ"
#include "content/shabbat/amidah-vayechulu.typ"
#include "content/shabbat/amidah-meein-sheva.typ"
#include "content/shared/kaddish-shalem.typ"
...
#sectionopener(3, "Concluding Prayers", "סִיּוּם",
  ...
  compact: true)
#include "content/shared/concluding-body.typ"
...
#v(8pt)
#include "content/shared/seasonal-insertions.typ"
#include "content/shabbat/kiddush.typ"
#include "content/shabbat/colophon.typ"
