#import "../book.typ": *
// New unit (panel v1.1, Wave 5): closes the Amidah section, after Me'ein Sheva,
// before the Concluding opener — Daniel's ruling, 2026-07-08 (Traditionalist
// Dissent). Shared paragraphs copied verbatim from the book's own verified
// Kaddish text (maariv-after.typ's Chatzi Kaddish; concluding-body.typ's
// Mourner's Kaddish) — not retyped from memory. Titkabel verified against
// Sefaria / Siddur Ashkenaz, Kaddish Shalem, before commit.
#startprayer("Kaddish Shalem · The Full Kaddish", "קַדִּישׁ שָׁלֵם", sec: "Amidah", newpage: true)
...
#stanza("Titkabél tz’lot’hón uva’ut’hón d’chol beit Yisra’él kodám avuhón di vishmayá, v’imrú: Amén.",
  "תִּתְקַבֵּל צְלוֹתְהוֹן וּבָעוּתְהוֹן דְּכָל בֵּית יִשְׂרָאֵל קֳדָם אֲבוּהוֹן דִּי בִשְׁמַיָּא וְאִמְרוּ אָמֵן.")
#eng("Receive the prayers and pleas of all the house of Israel before the One in heaven — and say: Amen.")
...
#chatimah("Oséh shalóm bimromáv, hu ya’aséh shalóm aléinu, v’al kol Yisra’él, v’al kol yosh’véi tevél, v’imrú: Amén.",
  ...
  [Kaddish comes in sizes. The Half-Kaddish marks a seam; this, the Full Kaddish, seals a whole service of prayer — its one extra sentence, titkabel, dares to ask that everything just prayed be received. On Friday night it follows Me'ein Sheva, closing the Amidah's arc before we turn toward home.])
