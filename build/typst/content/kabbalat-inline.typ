...
#stanza("Higalé na uf’ros, chavívi, alái et sukat sh’lomécha. Ta’ir éretz mik’vodécha, nagíla v’nism’chá bach. Maher ehóv ki va mo’éd, v’chonénu kimei olám.",
...
#engn("Be gracious to us as in the days of old.",
  [We open with #emph[Av harachamán], "compassionate Source." The Hebrew for compassion, #emph[rachamim], is built from #emph[rechem], the womb: to ask for God’s rachamim is to ask the Holy One to feel toward us as a womb feels toward what it holds — the tradition’s own deepest image of the mothering God. The poem is credited to Elazar Azikri (1533–1600) of Safed, its four stanzas opening with the letters of the divine Name.])
