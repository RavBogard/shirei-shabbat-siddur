...
#{
  ...
  v(8pt)
  text(size:10.5pt)[
    In the transliteration, an accent mark (as in *Elohéinu*) shows you the stressed syllable; most Hebrew
    words land on the last one. A small note at the foot of many prayers offers a piece of their story — a way to
  ...
  text(size:10.5pt)[
    ...
    at: Presence, Source, the One who was and is and will be. The Hebrew is untouched; the English
    is a door, not a wall — walk through whichever way you can.
  ]
  v(8pt)
  text(size:10.5pt)[
...
#{
  ...
  text(size:10.5pt)[
    ...
    wandered, we arrive there together, and move on together.
  ]
  v(10pt)

  eyebrow("One more small thing"); v(7pt)
  text(size:10.5pt)[
    At the foot of many pages, a short note offers a prayer’s story — history, a teaching, a question
    worth carrying home. And the single italic line tucked under the rail simply names what’s
    happening in this moment, in case you’d like the words for it.
  ]
}
#pagebreak()
