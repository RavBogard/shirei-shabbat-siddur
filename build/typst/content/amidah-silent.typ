...
#rubric([The silent Amidah — we rise and pray these seven blessings, each at our own pace.])

// ===================== OPENING · Adonai s’fatai =====================
#startprayer("We Open Our Lips", "אֲדֹנָי שְׂפָתַי", sec: "Amidah")
#ritual([some step in, feet together, like angels])
#stanza("Adonai, s’fatái tiftách, ufí yagíd t’hilatécha.",
  "אֲדֹנָי שְׂפָתַי תִּפְתָּח, וּפִי יַגִּיד תְּהִלָּתֶךָ.")
#v(1pt)
#text(size:9.5pt, style:"italic", fill:rgb("#2e2c26"))[You, open my lips — and my mouth will speak Your praise.#footnote[A single verse from Psalm 51 is the doorway into the Amidah. Before we ask for anything, we ask only for the ability to pray at all — a reminder that even our words are a gift we receive before we offer them.]#footnote[Some of us step in and stand feet together — one single foot, like the angels of Ezekiel’s vision — and bow four times across the prayer: knees bending at #emph[Barúch], body bowing at #emph[atá], standing straight again before the Name. At Modim, head and body bow together, "like a reed." Inherited choreography, freely offered — stand in this prayer however your body stands.]]
#v(4pt)

// ===================== 1 · AVOT V’IMAHOT =====================
#startprayer("Our Fathers and Mothers", "אָבוֹת וְאִמָּהוֹת", sec: "Amidah")
#ritual([some bow as the blessing opens])
#stanza("Barúch atá Adonai, Elohéinu ve’lohéi avotéinu v’imotéinu,",
  "בָּרוּךְ אַתָּה יְיָ, אֱלֹהֵינוּ וֵאלֹהֵי אֲבוֹתֵינוּ וְאִמּוֹתֵינוּ,")
#stanza("Elohéi Avrahám, Elohéi Yitzchák, ve’lohéi Ya’akóv;",
  "אֱלֹהֵי אַבְרָהָם, אֱלֹהֵי יִצְחָק, וֵאלֹהֵי יַעֲקֹב;")
#stanza("Elohéi Sará, Elohéi Rivká, Elohéi Le’á, Elohéi Rachél, Elohéi Bilhá, ve’lohéi Zilpá.",
...
// ===================== 4 · K’DUSHAT HAYOM =====================
#startprayer("The Holiness of the Day", "קְדֻשַּׁת הַיּוֹם", sec: "Amidah")
...
// ===================== 6 · MODIM =====================
#startprayer("We Give Thanks", "מוֹדִים", sec: "Amidah")
...
#stanza("V’al kulám yitbaréch v’yitromám shimchá tamíd l’olám va’éd. V’chol hachayím yodúcha sélah, vihal’lú et shimchá be’emét, ha’El y’shu’aténu v’ezraténu sélah. Barúch atá Adonai, hatóv shimchá ulchá na’éh l’hodót.",
  ...
  [#emph[Modim] is said with a slight bow, and tradition holds it is the one blessing a person must speak in their own voice rather than lean on the prayer leader — because gratitude, unlike petition, cannot be delegated. It thanks God not for the extraordinary but for the daily: the breath, the ordinary morning, the miracles "that are with us every day."])

// ===================== 7 · BIRKAT SHALOM · Shalom Rav =====================
...
#engn("Blessed are You, who blesses Your people Israel with peace.",
  [The Amidah ends where it has been reaching all along — #emph[shalom], peace, from the root meaning wholeness. #emph[Shalom Rav] is the shorter evening form of the peace blessing; the daytime service uses the longer #emph[Sim Shalom]. Both make peace the last word, the goal toward which every other blessing has been quietly bending.])

// ===================== CLOSING · Elohai N’tzor =====================
#startprayer("My God, Guard My Tongue", "אֱלֹהַי נְצוֹר", sec: "Amidah")
#stanza("Elohái, n’tzór l’shoní merá, usfatái midabér mirmá, v’limkal’lái nafshí tidóm, v’nafshí ke’afár lakól tihyéh. P’tach libí b’toratécha, uvmitzvotécha tirdóf nafshí.",
  "אֱלֹהַי, נְצוֹר לְשׁוֹנִי מֵרָע, וּשְׂפָתַי מִדַּבֵּר מִרְמָה, וְלִמְקַלְלַי נַפְשִׁי תִדּוֹם, וְנַפְשִׁי כֶּעָפָר לַכֹּל תִּהְיֶה. פְּתַח לִבִּי בְּתוֹרָתֶךָ, וּבְמִצְוֹתֶיךָ תִּרְדֹּף נַפְשִׁי.")
#stanza("V’chol hachosh’vím alái ra’á, m’herá hafér atzatám v’kalkél machashavtám. Aséh l’má’an sh’mécha, aséh l’má’an y’minécha, aséh l’má’an k’dushatécha, aséh l’má’an toratécha. L’má’an yechal’tzún y’didécha, hoshí’a y’min’chá va’anéni.",
  "וְכֹל הַחוֹשְׁבִים עָלַי רָעָה, מְהֵרָה הָפֵר עֲצָתָם וְקַלְקֵל מַחֲשַׁבְתָּם. עֲשֵׂה לְמַעַן שְׁמֶךָ, עֲשֵׂה לְמַעַן יְמִינֶךָ, עֲשֵׂה לְמַעַן קְדֻשָּׁתֶךָ, עֲשֵׂה לְמַעַן תּוֹרָתֶךָ. לְמַעַן יֵחָלְצוּן יְדִידֶיךָ, הוֹשִׁיעָה יְמִינְךָ וַעֲנֵנִי.")
#stanza("Yihyú l’ratzón imréi fi v’hegyón libí l’fanécha, Adonai tzurí v’go’alí.",
  "יִהְיוּ לְרָצוֹן אִמְרֵי פִי וְהֶגְיוֹן לִבִּי לְפָנֶיךָ, יְיָ צוּרִי וְגוֹאֲלִי.")
#ritual([some step back, bowing, taking leave])
#stanza("Oséh shalóm bimromáv, hu ya’aséh shalóm aléinu, v’al kol Yisra’él, v’al kol yosh’véi tevél, v’imrú: Amén.",
...
#eng("My God, guard my tongue from evil and my lips from speaking deceit. To those who wrong me, let my soul stay silent; let my soul be humble as the dust before all. Open my heart to Your Torah, that my soul may pursue Your mitzvot.")
#eng("And all who plan evil against me — quickly undo their designs and unravel their schemes. Act for the sake of Your name; act for the sake of Your right hand; act for the sake of Your holiness; act for the sake of Your Torah. That those You love may be freed, let Your right hand save — answer me.")
#eng("May the words of my mouth and the meditation of my heart be acceptable before You, my Rock and my Redeemer.")
  ...
  [The Amidah closes not with a fixed blessing but with a private meditation attributed to the fourth-century sage Mar bar Ravina (Berakhot 17a) — a turn inward from the grand "we" of the fixed prayers to a single, vulnerable "I" asking only to speak less harm and hold less pride. The verse from Psalm 19:15 hands our own imperfect words back to God; #emph[Oseh Shalom], the same plea for peace that seals the Kaddish, walks us gently back out into the world.])

#rubric([Here we may add our own words, in silence.])
