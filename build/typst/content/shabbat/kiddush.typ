...
#ts("Vay’chulu hashamayim v’ha’aretz v’chol tz’va’am.",
  "וַיְכֻלּ֛וּ הַשָּׁמַ֥יִם וְהָאָ֖רֶץ וְכׇל־צְבָאָֽם׃", label: "Vayechulu")
#ts("Vay’chal Elohim bayom hash’vi’i m’lachto asher asah, vayishbot bayom hash’vi’i mikol m’lachto asher asah.",
...
#ts("Vay’varech Elohim et yom hash’vi’i vay’kadesh oto, ki vo shavat mikol m’lachto asher bara Elohim la’asot.",
...
#stanza("Baruch ata Adonai, Eloheinu melech ha’olam, asher kid’shanu b’mitzvotav v’ratza vanu, v’Shabbat kodsho b’ahava uvratzon hinchilanu, zikaron l’ma’asei v’reishit.",
...
#stanza("Ki hu yom t’chila l’mikra’ei kodesh, zecher litzi’at mitzrayim.",
  "כִּי הוּא יוֹם תְּחִלָּה לְמִקְרָאֵי קֹדֶשׁ, זֵכֶר לִיצִיאַת מִצְרָיִם.")
#chatimah("Ki vanu vacharta v’otanu kidashta mikol ha’amim, v’Shabbat kodsh’cha b’ahava uvratzon hinchaltanu. Baruch ata Adonai, m’kadesh haShabbat.",
  ...
  [Kiddush means "sanctification": we do not merely welcome Shabbat — we declare it holy, aloud, over a full cup; the Sages taught to remember Shabbat over wine (Pesachim 106a). (And why does Kiddush live at the back of this book? Because its true home is a table: the oneg after the service is the heir of the very meal in the synagogue courtyard for which the synagogue Kiddush was first created.) Its blessing binds the two reasons the Torah gives for Shabbat — a remembrance of creation, and a reminder of the Exodus: the world made, and a people set free. And "chose us"? Many of us have flinched at it; we hear it not as rank but as task — every people is chosen for something, and this is ours: to keep this day.])
